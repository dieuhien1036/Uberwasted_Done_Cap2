...
public class DirectionJoin  {
    private double currentLatitude;
    private double currentLongtitude;
    private double wasteLatitude;
    private double wasteLongtitude;
    private DirectionJoinListener listener;

    public DirectionJoin(DirectionJoinListener listener, double currentLatitude, double currentLongtitude,
