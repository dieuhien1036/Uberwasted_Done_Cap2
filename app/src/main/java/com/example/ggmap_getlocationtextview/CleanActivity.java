...
public class CleanActivity extends AppCompatActivity {
    ...
    String urlDelete = "http://192.168.1.6/androidwebservice/deleteJoin.php";
    String url = "http://192.168.1.6/androidwebservice/WasteJoin.php";
    String urlCheckin = "http://192.168.1.6/androidwebservice/checkIn.php";
