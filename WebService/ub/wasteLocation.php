<?php
	...
	class location{
		function location($waste_id, $waste_latitude, $waste_longtitude, $waste_image, $waste_size, $waste_material, $waste_people, $waste_code, $waste_date, $waste_detail){
		...
		while($row = mysqli_fetch_assoc($data)){
			array_push($array_WasteLocation,new location($row['waste_id'],$row['waste_latitude'],$row['waste_longtitude'],
				$row['waste_image'],$row['waste_size'],$row['waste_material'],$row['waste_people'],$row['waste_code'],$row['waste_material'],$row['waste_date'],$row['waste_detail']));
		}
